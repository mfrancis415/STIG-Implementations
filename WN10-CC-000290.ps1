<#
.SYNOPSIS
    This PowerShell script ensures Remote Desktop sessions use strong encryption by setting MinEncryptionLevel to 3 in the Terminal Services policy registry key.
